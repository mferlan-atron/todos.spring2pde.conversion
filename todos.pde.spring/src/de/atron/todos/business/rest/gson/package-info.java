...
/**
 * This package contains Gson message body writer/reader. Normally this already exists as part of application. 
 * We are adding it here additionally to not reference any project that is not sample project
 * 
 * @author ferlan
 *
 */
