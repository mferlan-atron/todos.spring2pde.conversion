...
public class TaskDao implements ITaskDao  {
    ...
    /* (non-Javadoc)
	 * @see de.atron.todos.business.dao.ITaskDao#filterAll(de.atron.todos.business.entity.Filter)
	 */
    @Override
...
//        return listAll().parallelStream().filter(filter::matches).collect(Collectors.toList());
    ...
    /* (non-Javadoc)
	 * @see de.atron.todos.business.dao.ITaskDao#save(de.atron.todos.business.entity.Task)
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see de.atron.todos.business.dao.ITaskDao#update(de.atron.todos.business.entity.Task)
	 */
    @Override
